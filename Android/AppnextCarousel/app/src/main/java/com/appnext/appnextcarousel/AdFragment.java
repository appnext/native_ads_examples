...
public class AdFragment extends Fragment {
	...
	public static AdFragment newInstance(int position, AppnextAd ad) {
		...
		args.putInt(ITEM_PARAM_INT, position);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		new ImageDownloader(imageView).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, ad.getWideImageURL());

		new ImageDownloader((ImageView) rootView.findViewById(R.id.icon)).execute(ad.getImageURL());
		...
		rootView.findViewById(R.id.install).setOnClickListener(new View.OnClickListener() {
			@Override
