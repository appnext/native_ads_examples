...
public class InFeed1Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.infeed1_activity);
		...
		appnextAPI = new AppnextAPI(this, "c6d1b8dd-aa60-47f5-be7a-18ca586453da");
		appnextAPI.setAdListener(new AppnextAPI.AppnextAdListener() {
			...
			public void onError(String s) {
				Toast.makeText(InFeed1Activity.this, s, Toast.LENGTH_SHORT).show();
